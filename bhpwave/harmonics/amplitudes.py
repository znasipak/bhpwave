...
class HarmonicAmplitudes:
    ...
    ----------
    lmax : int, optional
        The maximum l-mode to pre-compile in the amplitude generator.
        The value of lmax is restricted to lmax :math:`\\leq 15`
    select_modes : list or array[tuple(double, double)], optional
        An option to specify which :math:`(l,m)` modes are evaluated by
        the amplitude generator. The default setting loads all modes in
        the range :math:`2 \\leq l \\leq 15`, :math:`1 \\leq |m| \\leq
        l`
    """
    ...
    def __call__(self, l, m, a, r):
        ...
        ----------
        l : int
            The spherical harmonic polar mode number
        m : int
            The spherical harmonic azimuthal mode number
        a : double
            Kerr spin parameter
        r : double
            Boyer-Lndquist radius of a circular geodesic in units of
            mass :math:`M`
